...
OceanRamen's original Brainstorm project is licensed under the Mozilla Public
License Version 2.0.

This rewrite's Lua mod code, Rust native code, and packaging are licensed under
